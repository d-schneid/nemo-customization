...
class StructureAwareStarcoder2Model(Starcoder2Model):
	...
	def forward(
			...
			ast_leaf_code_token_idxs: torch.Tensor,
			lr_paths_types: torch.Tensor,
			lr_paths_len: torch.Tensor,
			dfg_node_code_token_idxs: torch.Tensor,
		...
		output_tensor = self.module(
			...
			ll_sims=ll_sims,
			ast_leaf_code_token_idxs=ast_leaf_code_token_idxs,
			lr_paths_types=lr_paths_types,
			lr_paths_len=lr_paths_len,
			dfg_node_code_token_idxs=dfg_node_code_token_idxs,
			dfg_edges=dfg_edges,
