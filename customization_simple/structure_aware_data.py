...
with open('/shared/home/i741961/customization_simple_orig/data/pretraining/metadata.json', 'r') as f_metadata:
...
class StructureAwareDataModule(pl.LightningDataModule):
	...
	def setup(self, stage: str = "") -> None:
		self._train_ds = StructureAwareDataset('/shared/home/i741961/customization_simple_orig/data/pretraining')
		self._validation_ds = StructureAwareDataset('/shared/home/i741961/customization_simple_orig/data/pretraining')
		self._test_ds = StructureAwareDataset('/shared/home/i741961/customization_simple_orig/data/pretraining')
